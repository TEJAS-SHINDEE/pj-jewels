      ...
      <div className="relative grid grid-cols-1 lg:min-h-[500px] lg:grid-cols-[42%_58%]">
        ...
        <div className="relative flex items-center bg-[#fffdf8] px-5 py-12 sm:px-10 sm:py-14 md:px-14 lg:px-16 lg:py-16 xl:px-20">
          ...
          <div className="relative z-10 mx-auto w-full max-w-[500px]">
            ...
            <h1
              className="max-w-[520px] font-bold text-[34px] leading-[1.16] text-[#a07431] sm:text-[44px] md:text-[50px] lg:text-[48px] xl:text-[54px]"
            ...
            <div className="mt-5 flex items-center gap-2 sm:mt-6">
              <span className="h-px w-full bg-[#c9a768]" />
            ...
            <div className="mt-6 flex w-full flex-col gap-2.5 sm:mt-7 sm:w-auto sm:flex-row sm:flex-wrap sm:gap-3">
              ...
              <a
                href="#collections"
                className="w-full whitespace-nowrap border border-[#bd9556] px-6 py-3 text-center text-[10px] tracking-wide text-[#73572f] transition hover:bg-[#a77b35] hover:text-white sm:w-auto"
              >
                EXPLORE COLLECTION
              </a>
